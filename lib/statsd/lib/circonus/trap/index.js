...
const log = settings.logger.child({ module: 'statsd', submodule: 'circonus-backend-trap' });
...
module.exports = class Trap {
    ...
    constructor(checkType, forceMetricActivation) {
        ...
        if (checkType === 'group') {
            this.checkID = 'statsd';
            this.regFile = settings.statsd.cosi_statsd_check_file;
        } else if (checkType === 'host') {
            this.checkID = 'system';
            this.regFile = settings.statsd.cosi_system_check_file;
        }
