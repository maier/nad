...
class Circonus {
    ...
    constructor(events, cb) {
        ...
        if (settings.statsd.prefix.global !== '') {
            for (const key in settings.statsd.prefix) {
                if (key !== 'global') {
                    this.prefix[key] = [ settings.statsd.prefix.global ];
                }
            }
        }
        ...
        for (const key in settings.statsd.prefix) {
            if (key !== 'global') {
                ...
                if (settings.statsd.prefix[key] !== '') {
                    this.prefix[key].push(settings.statsd.prefix[key]);
                }
            }
        }
        ...
        if (settings.statsd.suffix.global !== '') {
            for (const key in settings.statsd.suffix) {
                if (key !== 'global') {
                    this.suffix[key] = [ settings.statsd.suffix.global ];
                }
            }
        }
        ...
        for (const key in settings.statsd.suffix) {
            if (key !== 'global') {
                ...
                if (settings.statsd.suffix[key] !== '') {
                    this.suffix[key].push(settings.statsd.suffix[key]);
                }
            }
        }
    ...
    submitMetrics(groupMetrics, hostMetrics) {
        ...
        if (this.checks.group.enabled) {
            if (Object.keys(groupMetrics).length > 0) {
                ...
                log.info('0 group metrics, skipping submission');
            }
        } else {
            log.info('group check disabled, skipping submission');
        }
        ...
        if (this.checks.host.enabled) {
            if (Object.keys(hostMetrics).length > 0) {
                ...
                log.info('0 host metrics, skipping submission');
            }
        } else {
            log.info('host check disabled, skipping submission');
        }
    }
    ...
    flushMetrics(calc_start, metrics) { // eslint-disable-line complexity, max-statements
        ...
        if (settings.statsd.sendProcessStats) {
            ...
            hostMetrics[metricName] = { _type: 'n', _value: process._getActiveRequests().length };
            ...
            hostMetrics[metricName] = { _type: 'n', _value:process._getActiveHandles().length };
            ...
            hostMetrics[metricName] = { _type: 'n', _value:process.uptime() };
        ...
        for (const key in statsd_stats) {
            ...
            hostMetrics[metricName] = { _type: 'n', _value: val };
        }
        ...
        if (this.checks.group.enabled) {
            ...
            hostMetrics[metricName] = { _type: 'n', _value: metricValue };
            ...
            hostMetrics[metricName] = { _type: 'n', _value:groupFlushTime };
            ...
            hostMetrics[metricName] = { _type: 'n', _value:groupFlushLength };
            ...
            hostMetrics[metricName] = { _type: 'n', _value:Object.keys(groupMetrics).length };
        }
        ...
        hostMetrics[metricName] = { _type: 'n', _value:hostFlushTime };
        ...
        hostMetrics[metricName] = { _type: 'n', _value:hostFlushLength };
        ...
        hostMetrics[this.prefix.gauge.concat(
            ...
            this.suffix.internal,
            this.suffix.gauge
        ).join(METRIC_DELIM)] = { _type: 'n', _value:calc_end[1] / 1000000 };
        ...
        hostMetrics[metricName] = { _type: 'n', _value:Object.keys(hostMetrics).length + 1 };
