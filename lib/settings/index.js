...
function setStatsdOptions(options) {
    ...
    try {
        ...
        instance.log.warn({ err: err.message }, 'unable to find cosi installation, all metrics will be sent to NAD');
    }
    ...
    if (instance.statsd.flushInterval < default_flush_interval) {
        instance.log.warn({ flushInterval: instance.statsd.flushInterval }, `invalid flush interval, using ${default_flush_interval}`);
